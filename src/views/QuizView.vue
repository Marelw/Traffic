<template>
    <div class="card text-center border-dark border-2">
        <div class="card-header">
            ...
            <div class="">
                <button
                    class="btn btn-secondary btn-sm btn-block mx-2"
                    type="button"
                    style="width: 20%"
                    @Click="startQuiz"
                >
                ...
                <button class="btn btn-secondary btn-sm btn-block mx-2" type="button" style="width: 20%" @Click="pause">
                    Pausa
                </button>
            </div>
        </div>
        <div class="card-body" v-if="!quizRunning">Välj "Start" för att påbörja Quiz!</div>
