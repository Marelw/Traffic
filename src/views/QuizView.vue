        ...
        <div class="card bg-info">
            <div class="row my-9">
                <div class="col-md-12 text-center mt-2 mb-9">
                    ...
                    <button class="btn btn-secondary mx-2" type="button" style="width: 20%" @Click="pause">
                        Pausa
                    </button>
                    ...
                    <p>
                        <span v-for="(q, i) in currentQuiz">
                            <span v-if="i < currentQuestion">
                                <svg width="12" height="12" viewBox="0 0 113 113" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    <path
                                        ...
                                        stroke="black" stroke-width="10.109" stroke-linecap="round" stroke-linejoin="round"/>
                                </svg>
                            </span>
                            <span v-if="i > currentQuestion">
                                <svg xmlns="http://www.w3.org/2000/svg" width="22" height="22" fill="currentColor" class="bi bi-signpost" viewBox="0 0 16 16">
                                    <path
                            ...
                            <span v-if="currentQuestion === i">
                                <svg width="22" height="22" viewBox="0 0 139 99" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    <path
