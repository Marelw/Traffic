<template>
    <div class="card text-center border-dark border-2">
        <div class="card-header">
                <div class="dropdown">
                    <button class="btn btn-secondary dropdown-toggle" type="button" id="dropdownMenuButton1" data-bs-toggle="dropdown" aria-expanded="false">{{ dropdownTitle }}</button>
            ...
            <div class="">
                <button class="btn btn-secondary btn-sm btn-block mx-2" type="button" style="width: 20%" @Click="play">Start</button>
                <button class="btn btn-secondary btn-sm btn-block mx-2" type="button" style="width: 20%" @Click="pause">Pausa</button>
            </div>
        </div>
        <div class="card-body">
